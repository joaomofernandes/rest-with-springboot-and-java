...
public class PersonControllerXmlTests extends AbstractIntegrationTests {
    ...
    public void testCreate() throws JsonProcessingException {
        ...
        assertEquals("Curral de Moinas", createdPerson.getAddress());
    ...
    private void mockPerson() {
        ...
        person.setAddress("Curral de Moinas");
