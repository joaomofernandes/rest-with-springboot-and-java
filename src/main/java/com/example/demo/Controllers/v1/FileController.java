...
public class FileController {
    ...
    public List<UploadFileResponseVO> uploadMultipleFile(@RequestParam("file") MultipartFile[] files){
    ...
    @GetMapping("/downloadFile/{filename:.+}") // :.+ é para interpretar a extensão do ficheiro.
